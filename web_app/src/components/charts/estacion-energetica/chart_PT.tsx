...
export function ChartPT() {
  ...
  // Transformar los datos a valores absolutos
  const absoluteData = React.useMemo(() => {
  ...
  }, [sampledData, selectedVariables]);

  return (
    <Card>
      <CardHeader className=" max-h-[400px] items-center space-y-0 border-b py-0 ">
        <div className="flex  space-x-2 sm:flex-row gap-x-2">
          <CardTitle className="text-lg font-semibold">
            {chartConfig.PAT.label}
          </CardTitle>
          <div className="flex space-x-2">
                <Tooltip open={tooltipOpen} onOpenChange={setTooltipOpen}>
                  ...
                  >
                    <span>
                      <strong className="text-justify">Potencia Activa:</strong> <br />
                        Es la energía que consumen los aparatos para funcionar y se mide 
                        en vatios (W). Representa la potencia efectiva en un sistema eléctrico.
                    </span>
                  </TooltipContent>
                </Tooltip>
          </div>
      ...
      <CardContent className="px-2 pt-4 sm:px-6 sm:pt-6">
        ...
        <ChartBasic
          data={absoluteData} // Usar los datos en valor absoluto
