        ...
        <div className="flex  space-x-2 sm:flex-row gap-x-2">
          ...
          <div className="flex space-x-2">
                <Tooltip open={tooltipOpen} onOpenChange={setTooltipOpen}>
                  ...
                  >
                    <span>
                      <strong className="text-justify">Corriente Eléctrica:</strong> <br />
                        Es el flujo de electrones en un conductor, medido en amperios (A).
                        Es esencial para calcular la potencia eléctrica (P = V × I) y 
