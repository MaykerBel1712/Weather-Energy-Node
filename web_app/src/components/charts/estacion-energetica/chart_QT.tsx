        ...
        <div className="flex  space-x-2 sm:flex-row gap-x-2">
          ...
          <div className="flex space-x-2">
            <Tooltip open={tooltipOpen} onOpenChange={setTooltipOpen}>
              ...
              >
                <span>
                  <strong className="text-justify">Potencia Reactiva:</strong> <br />
                  Es la energía que circula entre la fuente y algunos componentes 
                  del sistema eléctrico, como motores o transformadores, sin 
                  convertirse en trabajo útil. Se necesita para mantener los 
                  campos eléctricos y magnéticos, y se mide en voltamperios 
                  reactivos (VAR).
                </span>
              </TooltipContent>
            </Tooltip>
