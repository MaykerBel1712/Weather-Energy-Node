...
export function ChartAmbientTemperature() {
    ...
    <Card>
      ...
      <div className="flex  space-x-2 sm:flex-row gap-x-2">
          <CardTitle className="text-lg font-semibold">
            {chartConfig.AmbientTemperature.label}
          </CardTitle>
          <div className="flex space-x-2">
                <Tooltip open={tooltipOpen} onOpenChange={setTooltipOpen}>
                  ...
                  <TooltipContent 
                    ...
                    >
                    <span>
                      <strong className="text-justify">Temperatura:</strong><br/>
                      La temperatura es una magnitud física escalar que está 
                      relacionada con la energía interna de un sistema termodinámico, 
                      concretamente con la energía cinética media de sus partículas, 
                      referida al movimiento de estas.
                    </span>
                  </TooltipContent>
                </Tooltip>
          </div>
