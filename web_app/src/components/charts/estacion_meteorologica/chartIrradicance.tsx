...
export function ChartIrradiance() {
    ...
    <Card>
          ...
          <div className="flex space-x-2">
                <Tooltip open={tooltipOpen} onOpenChange={setTooltipOpen}>
                  ...
                  <TooltipContent 
                    ...
                    >
                    <span>
                      <strong>Radiación Solar:</strong><br/>
                      La radiación solar es la energía emitida por el sol en 
                      forma de ondas electromagnéticas que viajan a través del 
                      espacio y llegan a la Tierra.  Se mide en vatios por metro 
                      cuadrado (W/m²) y puede ser global o difusa.
                    </span>
                  </TooltipContent>
                </Tooltip>
          </div>
      ...
      <CardContent className="px-2 pt-4 sm:px-6 sm:pt-6">
        ...
        <ChartBasic
          ...
          ylabel="Irradiancia (W/m²)"// Etiqueta del eje Y
        />
      </CardContent>
    </Card>
  );
