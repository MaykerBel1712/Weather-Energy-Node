...
const chartConfig = {
    WindSpeed: {
        ...
        color: "rgba(100, 75, 192, 1)",
        },
};

export function ChartWindSpeed() {
          ...
          <div className="flex space-x-2">
                <Tooltip open={tooltipOpen} onOpenChange={setTooltipOpen}>
                  ...
                  <TooltipContent 
                    ...
                    >
                    <span>
                      <strong className="text-justify">Velocidad del Viento:</strong><br/>
                      La velocidad del viento es la rapidez con la que se mueve 
                      el aire en la atmósfera. Se mide en metros por segundo (m/s) o 
