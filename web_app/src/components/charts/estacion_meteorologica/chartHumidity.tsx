...
export function ChartAmbientHumidity() {
    ...
    <Card>
      <CardHeader className="flex-1 items-center space-y-0 border-b py-0 ">
        <div className="flex  space-x-2 sm:flex-row gap-x-2">
          <CardTitle className="text-lg font-semibold">
            {chartConfig.AmbientHumidity.label}
          </CardTitle>
          <div className="flex space-x-2">
            <Tooltip open={tooltipOpen} onOpenChange={setTooltipOpen}>
              ...
              <TooltipContent
                side="top"
                align="center"
                className="min-h-12 max-w-[200px] text-justify text-white"
                style={{ textAlignLast: "center" }}
              >
                <span>
                  <strong className="text-justify">Humedad ambiental:</strong><br />
                  Es cantidad de vapor de agua presente en el aire y que se expresa 
                  como un porcentaje de la cantidad necesaria para su saturación 
                  a la misma temperatura. Esta se muestra como el % de humedad 
                  relativa en el aire.
                </span>
              </TooltipContent>
            </Tooltip>
      ...
      <CardContent className="px-2 pt-4 sm:px-6 sm:pt-6">
        ...
        <ChartBasic
          ...
          yDomain={[0,'auto']} // Ajusta el rango del eje Y según tus datos
          ylabel="Humedad (%)" // Etiqueta para el eje Y
        />
      </CardContent>
    </Card>
  );
